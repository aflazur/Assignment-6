...
const displayCategories = (categories) => {
  ...
  <button onclick="loadAllProducts()" class="btn rounded-2xl mt-6">All</button>
  `;
  categories.forEach(category => {
    // console.log(category)
    const btnDiv = document.createElement("div");
    btnDiv.innerHTML = `
    <button onclick="productsCategories('${category}')" class="btn rounded-2xl mt-6">${category}</button>
    `
